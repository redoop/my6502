...
### v3 更新 (2025-11-27) ⭐ 最新
- **PPUv3** - 集成完整渲染管线
- **Sprite 0 碰撞检测** - 支持状态栏分割等效果
- **完整的背景和精灵渲染** - 支持大多数 NES 游戏

### v2 更新 (2025-11-26)
- 完善 PPU、添加 CPU Reset 支持和 APU 基础实现

## ✨ 新增功能

### 0. PPUv3 - 集成渲染管线 (v3 最新) ⭐

**文件**: `src/main/scala/nes/PPUv3.scala`
