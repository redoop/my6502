...
int main() {
    ...
    // 加载 Mini BASIC 到 0x0300
    FILE* f = fopen("basic/mini.bin", "rb");
    if (!f) { printf("Can't open mini.bin\n"); return 1; }
    ...
    printf("Loaded Mini BASIC (%ld bytes at 0x0300)\n", size);
    ...
    printf("Starting Mini BASIC (type: PRINT \"HELLO\")...\n\n");
