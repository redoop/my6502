...
ERRSTR   .word $2041, $5420          ; " AT " string used in error reporting.  Tom was right about this.
...
;
; Get a character from input port $F001
;
RCCHR    lda $F001                  ; Read from input port
         beq RCCHR                  ; Loop until we get one
         rts                        ; Return

;
;Send a character to output port $F000
;
SNDCHR   sta $F000                  ; Write to output port
         rts                        ; Return
