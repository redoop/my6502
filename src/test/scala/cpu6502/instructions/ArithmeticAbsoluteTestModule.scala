...
class ArithmeticAbsoluteTestModule extends Module {
  ...
  val result = ArithmeticInstructions.executeADCSBCAbsolute(io.opcode, io.cycle, regs, io.operand, io.memDataIn)
